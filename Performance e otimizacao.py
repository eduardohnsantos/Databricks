...
# MAGIC %sql 
# MAGIC DROP TABLE IF EXISTS hotel; -- Carregando de arquivos Parquet sobre dados de hotel 
...
# MAGIC %sql -- Fazendo uma contagem das principais categorias e comentarios 
...
# MAGIC %sql -- Criando a tabela Delta 
...
# MAGIC %sql -- Otimizando a consulta da tabela Delta com o campo Pais, é importante que busque o campo que melhor otimiza 
# MAGIC OPTIMIZE hotel ZORDER BY (Pais); -- Executando a consulta otimizada na tabela Delta  
# MAGIC
